...
@section('importUsers')
    <div class="heading">
        <h1>Նախազգուշացված օգտատերներ</h1>
    </div>
    <div class="showUsers">
        <div class="individualUsers">
            ...
            <div class="usersBlock">
                @foreach ($users as $value)
                    @if ($value->category_user == 'individual' && $value->warned == 1 && $value->blocked !== 1)
        ...
        <div class="organizationUsers">
            ...
            <div class="usersBlock">
                @foreach ($users as $value)
                    @if ($value->category_user == 'organization' && $value->warned == 1 && $value->blocked !== 1)
                        <div id="{{ $value->id }}" class="userBox">
                            <div class="image">
                                <img src="{{ asset('images/user/user-profile.png') }}" alt="User-profile">
                            </div>
